...
import cursojava.interfaces.PermitrAcesso;
...
public class PrimeiraClasseJava {
	public static void main(String[] args) {
		...
		/*
		 * Secretario secretario = new Secretario(); secretario.setLogin(login);
		 * secretario.setSenha(senha);
		 */

		PermitrAcesso secretario = new Secretario();
		/*
		 * Testando o login através da interface
		 */
